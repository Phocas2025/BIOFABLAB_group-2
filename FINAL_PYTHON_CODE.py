...
def parse_data(data):
    ...
    try:
        ...
        print(f"Error parsing data: {e} | Data received: {data}")
        return None, None
...
def move_displacement(x):
    ...
    print(f"Moving stepper by {new_target:.3f} mm {'clockwise' if x > 0 else 'counterclockwise'}")
...
def move_and_read(x):
    ...
    # ** Automatic tare 0.1s after movement starts **
    time.sleep(0.01)
    tare()
